...
`infra/cloudflare/README.md`, start Docker with the `cloudflare` profile, and run
`scripts/dns_bootstrap.py` to publish the required CNAME pointing at the
`*.cfargotunnel.com` endpoint generated by Cloudflare.
